...
function Home() {
  return (
    <div id="Home" className="home">
      <ProfileIcons />
      <div className='d-flex-column w-75 home_content position-relative mt-8'>
        <div className='d-flex name-intro font-weight-bold justify-content-center name-intro'>
